...
var blueToothFn = function blueToothFn(target) {
  ...
  var signUrl = "https://xz.parkbobo.com/wxConfig/weixin/v1/jsSdkSign"; // const signUrl = `https://gisapp.swun.edu.cn/wxConfig/weixin/v1/jsSdkSign`;

  var getIbeconUrl = "https://map.parkbobo.com/location/weka/v1/classify"; // map
      ...
      _createClass(bluetooth, [{
        ...
        value: function configWx(sign) {
          ...
          _weixinJsSdk.default.config({
            ...
            beta: true,
            //用于在页面加载之初调用JSAPI
            jsApiList: ["openWXDeviceLib", "closeWXDeviceLib", "onWXDeviceBluetoothStateChange", "startSearchBeacons", "stopSearchBeacons", "onSearchBeacons", "startRecord", "stopRecord", "translateVoice", "onMenuShareAppMessage", "getLocation", "openBluetoothAdapter", "onWXDeviceBluetoothStateChange", "getBluetoothAdapterState"] // 必填，需要使用的JS接口列表
...
//# sourceMappingURL=wb-positioning-jssdk.js.map